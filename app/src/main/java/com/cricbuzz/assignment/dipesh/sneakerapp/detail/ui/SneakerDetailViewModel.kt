...
class SneakerDetailViewModel(
    ...
    private val sneakerItem_ = MutableLiveData<SneakerItem>()
    val sneakerItem: LiveData<SneakerItem> = sneakerItem_
    fun loadSneakerDetailBasedOnId(id: String) {
        viewModelScope.launch {
            sneakerItem_.postValue(sneakerRepository.loadSneakerById(id))
        }
    }
